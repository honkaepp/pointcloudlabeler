...
**Tree segmentation and forest inventory from terrestrial and mobile laser scans.**

An out-of-core, octree-streaming point-cloud editor for forestry research.
PointCloudLabeler turns raw terrestrial and mobile laser scans into traceable
per-tree measurements — height, DBH, stem taper, basal area, crown
metrics, biomass and carbon — with end-to-end uncertainty propagation
...
Version 0.1.0 is the first public release: a Windows installer on the
